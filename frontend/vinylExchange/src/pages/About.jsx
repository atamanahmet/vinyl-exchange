  ...
  return (
    <>
      <div className="text-left -ml-25 -mt-50">
        ...
        {/* <div>
          <h1 className=""> About Vinyl Exchange</h1>
          <p className="text-2xl">
            We don’t care about charts, clicks, or algorithms. We care about
            vinyl. The crackle. The groove. The feeling you get when you drop
            the needle and the music hits just right. Vinyl Exchange is for
            people who just love records. Period. Trade, sell, or collect —
            whatever floats your boat. If it spins, we’re into it. Here, you’ll
            find: Rare pressings that make your collection scream “heck yes!” A
            place to swap with folks who get it Cover art that’s worth staring
            at longer than your screen time No corporate nonsense. No fancy
            rules. Just records, music, and the obsession that comes with it.
