...
import com.vinyl.VinylExchange.cart.dto.AddToCartRequest;
...
public class CartController {
        ...
        public ResponseEntity<HttpStatus> updateCart(@AuthenticationPrincipal UserPrincipal userPrincipal,
                        @PathVariable(name = "cartItemId", required = true) UUID cartItemId) {
        ...
        @DeleteMapping
        public ResponseEntity<HttpStatus> clearCart(@AuthenticationPrincipal UserPrincipal userPrincipal) {
