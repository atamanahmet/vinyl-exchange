...
import com.vinyl.VinylExchange.listing.label.LabelRepository;
import com.vinyl.VinylExchange.shared.pojo.ArtistCredit;
    ...
    public void saveReleases(RootResponse response) {
        ...
        for (Release release : response.getReleases()) {
            ...
            if (release.getLabelInfo() != null && !release.getLabelInfo().isEmpty()) {
                ...
                LabelInfo labelInfo = release.getLabelInfo().get(0);
            ...
            if (release.getArtistCredit() != null && !release.getArtistCredit().isEmpty()) {
                ...
                ArtistCredit artistCredit = release.getArtistCredit().get(0);
